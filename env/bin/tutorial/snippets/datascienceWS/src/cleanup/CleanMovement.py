...
class CleanMovement:
    ...
    def get_start_end_date_of_curr_movement_db(self, employer_name, list_employers_of_candidate):
        ...
        # new_start_date = None
        # new_end_date = None
        new_start_date = cleanDate.validateDateTime(
            list_employers_of_candidate.get_value(0, templData.db_col_start_date))
                ...
                if (list_employers_of_candidate.get_value(row_index, templData.db_col_employer_name).upper() == employer_name.upper()):
                    ...
                    if (not None in (start_date_curr, end_date_past)):
                        ...
                        if diff_date >= 45 :
                            ...
                            # index_start_date_movement = row_index
                            new_start_date = cleanDate.validateDateTime(list_employers_of_candidate.get_value(row_index + 1, templData.db_col_start_date))
                            break
