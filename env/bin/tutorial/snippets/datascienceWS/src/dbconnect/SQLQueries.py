...
query_candidate_data_by_email_employer = "SELECT " \
                                    "can.candidate_id," \
                                    "can.candidate_email,"\
                                    ...
                                    "WHERE can.candidate_email = %(can_email)s "\
                                    "AND upper(em.c_employment_employer_name) = upper(%(can_emp_name)s)"


# Query candidate data by email
query_candidate_data_by_email = "SELECT "\
                            "can.candidate_id,"\
                            "can.candidate_email,"\
                            "em.c_employment_employer_name,"\
                            "em.c_employment_job_start,"\
...
query_fortune_company = "SELECT count(*) "\
